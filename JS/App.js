...
var SignatureData =   {
        ...
        "svg": {
            "signs": [
                "0,3C3F786D6C2076657273696F6E3D22312E302220656E63",
                "0,3C73766720"
            ],
            "mime": "image/svg+xml"
        },
        ...
        "docx": {
            "signs": [
                ...
                "0,504B030414",
                "0,504B3414"
                //4C6162206576616C756174696F6EDA4B61727468696B6579616EDA63622E
            ],
...
var MoreTypeDetails=document.querySelector('.MoreTypeDetails');
var Landing=document.querySelector('.Landing');
var workspace=document.querySelector('.Workspace')
var outputFileType=document.querySelector('#FileType')
var outputFileextensionBefore=document.querySelector('#FileExtBefore')
...
const render = () => {
    ...
    console.log(uploadedFile.hex)
    // container.innerHTML =
    //         `<div>
    //         <strong>${uploadedFile.filename}</strong><br>
    //         Filetype from file object: ${uploadedFile.filetype}<br>
    //         Filetype from binary: ${uploadedFile.binaryFileType}<br>
    //         Hex: <em>${uploadedFile.hex}</em>
    //         </div>`
...
var Detect_Actual_FileType=()=>{
    ...
    outputFileextensionBefore.innerText=extension;
    let extensionString="";
    let mimeString="";
    var flag=false;
    ...
    MoreTypeDetails.innerText=extensionString.slice(0,extensionString.length-1)?"More possible extensions are "+extensionString.slice(0,extensionString.length-1):"no more possible extensions";
}   
